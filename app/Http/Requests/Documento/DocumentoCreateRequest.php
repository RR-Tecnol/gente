    ...
    public function rules() {
        return [
            ...
            "DOCUMENTO_NUMERO"  => [
                ...
                "required",
                "min:3",
                // new CpfValidoRule($this->post("TIPO_DOCUMENTO_ID")),
                Rule::unique("DOCUMENTO")->where(function (Builder $query) {
                    $query->where("TIPO_DOCUMENTO_ID", $this->post("TIPO_DOCUMENTO_ID"))
                        ->where("DOCUMENTO_NUMERO", $this->post("DOCUMENTO_NUMERO"));
                }),
