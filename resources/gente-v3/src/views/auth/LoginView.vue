      ...
      <div class="side-right">
        <div class="form-wrapper">
          ...
          <form @submit.prevent="handleLogin" class="login-form">
            ...
            <!-- CPF (apenas números) ou e-mail completo — sem máscara; o backend normaliza -->
            <div class="field-group" :class="{ focused: focusLogin }">
...
const handleLogin = async () => {
  ...
  try {
    ...
    // Uma identidade por pessoa: perfis vêm todos em /me (perfil_chaves) — sem modal de escolha de conta.
    // USUARIO_LOGIN: enviado puro (CPF com ou sem máscara, ou e-mail) — o Laravel aplica LoginLookupNormalizer
    const payload = {
    ...
    if (u) {
      authStore.setSessionUser(u)
    } else {
      authStore.clearCache()
    }
    if (u?.force_password_change) {
      return router.push({ name: 'PrimeiroAcesso' })
    }
