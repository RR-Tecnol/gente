...
// ═══════════════════════════════════════════════════════════════════════
// MÓDULOS NOVOS DA API V3 (Criados recentemente)
// ═══════════════════════════════════════════════════════════════════════
Route::prefix('api/v3')->middleware(['web', 'auth', 'alterar.senha'])->group(function () {
    require __DIR__ . '/dependentes.php';
    require __DIR__ . '/afastamentos_v3.php';
    require __DIR__ . '/progressao_funcional.php';
    require __DIR__ . '/avaliacao_desempenho.php';
    require __DIR__ . '/escala_trabalho.php';
